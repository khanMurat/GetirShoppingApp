...
extension UICollectionView {
    ...
    func registerHeader<T: UICollectionReusableView>(viewType : T.Type , bundle : Bundle? = nil) {
        
        let className = viewType.className
        
        register(viewType, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: viewType.className)
    }
